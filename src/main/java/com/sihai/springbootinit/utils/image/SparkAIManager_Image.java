...
public class SparkAIManager_Image extends WebSocketListener {
    ...
    public static final String appid = "0b67b268";
    public static final String apiSecret = "MGRhY2Y0ZTNmNjJlMGMyNGFjNmI0Zjdj";
    public static final String apiKey = "8184f821899deefd9e658c24dca9d171";
...
//    public static List<RoleContent> historyList = new ArrayList<>(); // 对话历史存储集合
    ...
    // 构造函数
    public SparkAIManager_Image(String userId, Boolean wsCloseFlag) {
        this.userId = userId;
        this.wsCloseFlag = wsCloseFlag;
    }

    public SparkAIManager_Image(File file, RedissonClient redissonClient, Long id) {
        this.file = file;
    ...
    public void getResult(String question){
        try {
            ...
            for (int i = 0; i < 1; i++) {
                totalAnswer = "";
                WebSocket webSocket = client.newWebSocket(request, new SparkAIManager_Image(i + "",
                        false));
            }
        }catch (Exception e){
            e.printStackTrace();
